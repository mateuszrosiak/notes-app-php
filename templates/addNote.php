...
<div class="font-sans aling-center">
    <h1 class="font-sans break-normal text-gray-900 pt-6 pb-2 text-xl">Add new note</h1>
    <hr class="border-b border-gray-400">
</div>

<div class="mt-6">
    <form action="/?action=addNote" method="POST" name="addNewNote" class="">
        <div class="grid gap-6 mb-6 md:grid-cols-1">
            <div class="mb-6 w-1/3">
                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Note title</label>
            ...
            <div class="mb-6 w-1/2">
                ...
                <textarea name="note" class="h-24 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required></textarea>
            </div>
        </div>
